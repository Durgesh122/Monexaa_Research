...
import { FaPlus, FaUniversalAccess, FaWhatsapp, FaPhone, FaVolumeUp, FaCommentDots } from 'react-icons/fa';
...
const FloatingButtons = () => {
  ...
  return (
    <div className="fixed bottom-6 right-2 md:right-6 z-[9999] flex flex-col items-center">
